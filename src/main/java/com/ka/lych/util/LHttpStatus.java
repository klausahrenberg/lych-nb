...
public enum LHttpStatus {
	...
	private static final LHttpStatus[] VALUES;
	...
	LHttpStatus(int value, Series series, String reasonPhrase) {
		this.value = value;
		this.series = series;
	 ...
	 */
	public static LHttpStatus valueOf(int statusCode) {
		LHttpStatus status = resolve(statusCode);
		if (status == null) {
	 ...
	 * @since 5.0
	 */	
	public static LHttpStatus resolve(int statusCode) {
		// Use cached VALUES instead of values() to prevent array allocation.
		for (LHttpStatus status : VALUES) {
